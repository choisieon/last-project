...
class YouthPolicy(models.Model):
    ...
    region = models.CharField("시행지역", max_length=100, blank=True)
    period = models.CharField("신청기간", max_length=100, blank=True)
    URL_ADD = models.URLField("신청URL", max_length=100, blank=True)
